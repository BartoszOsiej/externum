...
Examples:
  ...
  externum program.ext -o out.py       # compile to a file
    ...
    run_p.add_argument('--backend', choices=['vm', 'python'], default='python',
    ...
    comp.add_argument('--target', choices=['python', 'binary', 'bash', 'all', 'bytecode'],
...
def main(argv=None) -> None:
    ...
    if argv and argv[0] not in ('run', 'repl', 'compile', 'keygen', 'check', 'vm', 'ide') and not argv[0].startswith('-'):
        argv = ['compile'] + argv
